	...
	<div class="col-md-5">
		<div class="card">
			<div class="card-header">
				Create/Edit Thương hiệu
			</div>
			<form class="form-horizontal" id="formSubmit" method="post" action="{{isset($data['term']) ? route('brand.update',array('brand'=>$data['term']->id)) : route('brand.store')}}">
				<div class="card-body">
					<input type="hidden" name="taxonomy" value="brand">
...
<script type="text/javascript">
	function destroy(form){
		var anwser =  confirm("Bạn muốn xóa brand này?");
		if(anwser){
